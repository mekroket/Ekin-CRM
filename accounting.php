    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
            <header class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Muhasebe ve Finans</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div
                    ...
                    <h3
                        class="text-2xl font-bold <?php echo $net_profit >= 0 ? 'text-slate-900 dark:text-white' : 'text-red-600 dark:text-red-400'; ?>">
            ...
            <div
                ...
                <div class="p-6 border-b border-slate-200 dark:border-slate-800">
                    <h3 class="text-lg font-bold text-slate-900 dark:text-white">Gider Kayıtları</h3>
                </div>
                        ...
                        <?php else: ?>
                            <?php foreach ($expenses as $expense): ?>
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <span
                                            class="px-3 py-1 text-xs font-medium rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 uppercase">
    ...
    <div id="addExpenseModal"
        ...
        <div
            ...
            <div class="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                <h3 class="text-xl font-bold text-slate-900 dark:text-white">Yeni Gider Ekle</h3>
